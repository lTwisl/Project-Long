...
{
    protected SerializedProperty _сategoryProp;
    ...
    {
        _сategoryProp = serializedObject.FindProperty("<Category>k__BackingField");
    ...
    private void DrawCategoryProp(string typeName)
    {
        ...
        EditorGUILayout.PropertyField(_сategoryProp);
