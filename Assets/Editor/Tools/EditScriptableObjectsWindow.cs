...
public class EditScriptableObjectsWindow : EditorWindow
{
    private const string WINDOW_TITLE = "Edit Scriptable Objects Window";
    ...
    {
        GetWindow<EditScriptableObjectsWindow>(WINDOW_TITLE);
    }
    ...
    private void DrawControlPanel()
    {
        ...
        {
            GUILayout.Label("Сортировать по:", _infoStyle, GUILayout.Width(100));
