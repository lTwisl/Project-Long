...
[CreateAssetMenu(fileName = "Movement Settings", menuName = "Scriptable Objects/Movement Settings File")]
public class MovementSettings : ScriptableObject
{
    [field: Header("- - Movement:")]
    [field: SerializeField, Min(0)] public float WalkSpeed { get; private set; } = 3f;
    [field: SerializeField, Min(0)] public float RunSpeed { get; private set; } = 7f;
    ...
    [field: Header("- - Jump:")]
    [field: SerializeField, Min(0)] public float JumpForce { get; private set; } = 6f;
    [field: SerializeField, Min(0)] public float JumpCooldown { get; private set; } = 0.25f;
    [field: SerializeField, Min(0)] public float AirAcceleration { get; private set; } = 10f;
